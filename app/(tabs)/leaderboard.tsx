...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontWeight: '900', color: Colors.gold, letterSpacing: 1 },
  ...
  myRankNum: { fontSize: 24, fontWeight: '900', color: Colors.gold, minWidth: 40 },
  myRankName: { fontSize: 15, fontWeight: '700', color: Colors.textPrimary },
  myRankGames: { fontSize: 11, color: Colors.textSecondary },
  myRankRight: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  myRankCoins: { fontSize: 18, fontWeight: '800', color: Colors.gold },
  ...
  podiumName: { fontSize: 11, color: Colors.textSecondary, fontWeight: '600', marginBottom: 2, textAlign: 'center' },
  podiumCoins: { fontSize: 13, color: Colors.gold, fontWeight: '700', marginBottom: 4 },
  ...
  podiumRank: { fontSize: 16, fontWeight: '900', color: Colors.backgroundDeep },
  ...
  rankNum: { fontSize: 14, fontWeight: '700', color: Colors.textMuted, width: 28 },
  ...
  rankGames: { fontSize: 11, color: Colors.textMuted },
  rankCoinsContainer: { alignItems: 'flex-end' },
  rankCoins: { fontSize: 16, fontWeight: '800', color: Colors.gold },
  rankCoinLabel: { fontSize: 10, color: Colors.textMuted },
  ...
  joinText: { fontSize: 14, color: Colors.textSecondary, textAlign: 'center', lineHeight: 20 },
});
